...
export const MemvidConfigSchema = Type.Object(
     {
          ...
          ticketSource: Type.Optional(
               Type.Union([Type.Literal('self-hosted'), Type.Literal('cloud')])
          ),
...
export const memvidConfigSchema = {
     parse(value: unknown): MemvidConfig {
          ...
          return {
               memvidPath:
                    typeof cfg.memvidPath === 'string'
                         ? cfg.memvidPath
                         : undefined,
               archivesDir:
                    typeof cfg.archivesDir === 'string'
                         ? cfg.archivesDir
                         : undefined,
               ...
               enrichmentEngine:
                    ...
                    cfg.enrichmentEngine === 'cloud'
                         ...
                         : undefined,
               autoCapture:
                    typeof cfg.autoCapture === 'boolean'
                         ? cfg.autoCapture
                         : undefined,
               autoRecall:
                    typeof cfg.autoRecall === 'boolean'
                         ...
                         : undefined,
               autoArchiveSessions:
                    typeof cfg.autoArchiveSessions === 'boolean'
                         ? cfg.autoArchiveSessions
                         : undefined,
               sessionArchiveThresholdMB:
                    typeof cfg.sessionArchiveThresholdMB === 'number'
                         ...
                         : undefined,
               ticketSource:
                    cfg.ticketSource === 'self-hosted' ||
                    cfg.ticketSource === 'cloud'
                         ? cfg.ticketSource
                         : undefined,
               ticketIssuer:
                    typeof cfg.ticketIssuer === 'string'
                         ? cfg.ticketIssuer
                         : undefined,
               autoExpandCapacity:
                    typeof cfg.autoExpandCapacity === 'boolean'
                         ? cfg.autoExpandCapacity
                         : undefined,
               capacityThresholdPercent:
                    typeof cfg.capacityThresholdPercent === 'number'
                         ? cfg.capacityThresholdPercent
                         : undefined,
          };
     },
     uiHints: {
