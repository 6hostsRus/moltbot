     ...
     api.registerTool(
          {
               ...
               description:
                    'Archive a session transcript to Memvid for long-term semantic search',
               ...
               parameters: Type.Object({
                    ...
                    archiveName: Type.Optional(
                         Type.String({
                              description:
                                   'Custom archive name (default: auto-generated from agentId)',
                         })
                    ),
               }),
               async execute(_toolCallId, params) {
                    ...
                    try {
                         ...
                         const targetArchive =
                              archiveName || `default-sessions.mv2`;
                         const archivePath =
